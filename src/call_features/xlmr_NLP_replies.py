...
# Dataset class to parse your transcriptions into a structured format
class TranscriptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Combine English and Mandarin text if applicable
        ...
        # Set labels based on if the speaker is 'Customer'
        label = 1 if speaker == "CALLEE" else 0
...
# Save the model
model.save_pretrained(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../models/replies_xlm_roberta')))
tokenizer.save_pretrained(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../models/replies_xlm_roberta')))